...
import { linkResolvedDataflowSymbolsForSlack, markdownToSlackMrkdwnChunks } from "../format.js";
...
export async function deliverReplies(params: {
  ...
  for (const payload of params.replies) {
    ...
    if (payload.text) {
      ...
      payload.text = linkResolvedDataflowSymbolsForSlack({
        sourceText,
        resolvedText: hookResult.content,
        symbolLinkUrl: params.symbolLinkUrl,
      });
    }
